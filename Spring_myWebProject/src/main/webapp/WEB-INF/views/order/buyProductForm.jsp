									...
									<form class="" action="buyProductPro" name="buyProductForm">  
										...
										<div class="order-list">
											...
											<table  class="order-table" style="border:1px solid black">
												...
												<tr class="order-table_row">
													<td class="order-table_column">${pVo.product_price }</td>
													<td class="order-table_column">0</td>
													<td class="order-table_column">${pVo.product_price * pVo.product_amount }</td>
												</tr>
											</table>
											<br><br>
											<h3>02. 배송지</h3>
											<table class="order-table" style="border:1px solid black">
												<tr class="order-table_row">
													...
													<td colspan="3">
														${mVo.name }&nbsp;&nbsp;|&nbsp;&nbsp;${mVo.email}&nbsp;&nbsp;|&nbsp;&nbsp;${mVo.hp}&nbsp;&nbsp; >> 주문/배송에 관한 SMS 및 메일이 발송됩니다.
													</td>
												</tr>
												<tr class="order-table_row">
													<td class="order-table_column">
