						...
						<section class="account-wrapper-account-page-orders-all">
							...
							<div class="account-body">
								<div class="account-header">
									<h1 class="account-heading">상품정보 수정</h1>
									<div class="account-toolbar"></div>
								</div>
								<div class="account-empty">
									<form action="host_udtInvenPro.pdt" enctype="multipart/form-data" method="post" name="udtView">
										<table class="inventory_table" style="border:1px solid black">
											...
											<c:if test="${requestScope.pVo != null }">
													<tr class="inventory_row" style="text-align:center">
														<td class="inventory_column"><input type="text" name="num" value="${pVo.num }" readonly> </td>
														<td class="inventory_column" colspan="2"><input name="product_code" type="text" value="${pVo.product_code }" readonly> </td>
														<td class="inventory_column" colspan="2"><input name="product_company" type="text" value=" ${pVo.product_company }"> </td>
														<td class="inventory_column" colspan="2"><input name="product_name" type="text" value="${pVo.product_name }"> </td>
														<td class="inventory_column" colspan="2"><input name="product_price" type="text" value="${pVo.product_price }"> </td>
														<td class="inventory_column" colspan="2"><input name="product_amount" type="text" value="${pVo.product_amount }"> </td>
														<td class="inventory_column" colspan="2"><input type="file" name="product_image" value="${pVo.img_path }"></td>
													</tr>
											</c:if>
											<c:if test="${requestScope.pVo == null }">
												<tr>
													<td class="inventory_column" colspan="2"> 잘못된 코드입니다.</td>
												</tr>
											</c:if>
											<tr>
												<td>
													...
													<input type="button" value="관리자화면으로" onclick="window.location='host_myAccount.pdt'">
												</td>
											</tr>
										</table>
									</form>
