						...
						<section class="account-wrapper-account-page-orders-all">
							<nav class="account-nav">
								<ul class="account-nav-list">
									...
									<li class="account-nav-item">
										<a class="account-nav-link" href="boardList.board">공지사항</a>
									</li>
									<li class="account-nav-item">
							...
							<div class="account-body">
								<div class="account-header">
									<h1 class="account-heading">재고삭제</h1>
									<div class="account-toolbar"></div>
								</div>
								<div class="account-empty">
									<form action="host_sltInvenPro.pdt" method="get" onsubmit="return sltInvenChk();" style="margin-left:45%;">
										<fieldset>
											<legend>재고 찾기</legend>
											<table border="1">
												<tr>
													...
													<td><input type="text" name="searchCode"></td>
												</tr>
											</table>
